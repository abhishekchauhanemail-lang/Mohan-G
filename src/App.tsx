          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div>
              ...
              <div className="prose prose-invert prose-lg text-brand-ink/60 leading-relaxed font-display italic text-2xl mb-12">
                <p>
                  "From Taliya to Milan, hospitality has been my bridge to the world. At MohanG SRL, we don't just manage assets; we cultivate success through an unwavering entrepreneurial spirit."
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-12">
                     ...
                     <div className="group cursor-pointer">
                        ...
                        <a href="mailto:info@mohangsrl.com" className="text-3xl font-display font-light text-brand-ink/80 group-hover:text-white transition-colors underline underline-offset-8">info@mohangsrl.com</a>
                     </div>
                  </div>
                </div>
